...
init: 	stp	x29, x30, [sp, alloc]!
		...
		str w9, [x8, n_s + struct1_s + i1_s]
		ldr w9, [x29, n_s + struct1_s + j1_s]
		str w9, [x8, n_s + struct2_s + struct2_s]
		ldr w9, [x29, n_s + struct2_s + i2_s]
		str w9, [x8, n_s + struct2_s + i2_s]
		ldr w9, [x29, n_s + struct2_s + j2_s]
		str w9, [x8, n_s + struct2_s + j2_S]
...
printstruct:
			...
			ldr		w4, [x0, struct2_s + i2_s]
			ldr		w5, [x0, struct2_s + j2_s]
			adrp	x0, fmtprint
